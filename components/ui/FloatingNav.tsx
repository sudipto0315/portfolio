...
export const FloatingNav = ({
  ...
  const [visible, setVisible] = useState(true); // Set initial visibility to true
  ...
  useMotionValueEvent(scrollYProgress, "change", (current) => {
    ...
    if (typeof current === "number") {
      const previous = scrollYProgress.getPrevious() ?? 0; // Provide a default value
    ...
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <button className="border text-sm font-medium relative border-neutral-200 dark:border-white/[0.2] text-black dark:text-white px-4 py-2 rounded-full">
          <span>
            <a href="https://drive.google.com/file/d/10HJrPTpIyxDw120aebWNrsJh_OA5c9kZ/view?usp=sharing">Resume</a>
          </span>
